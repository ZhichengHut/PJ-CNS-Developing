...
public class GifEncoder {
	...
	/**
	 * adds an Image from GlobalColorTable and Indices Stream setSize needs to
	 ...
	 * 
	 */
	public boolean addImage(byte[] colorTable, byte[] pixels) {
		boolean ok = true;
		try {
			colorDepth = 8;
			writeLSD();
			...
			writeGraphicCtrlExt();
			writeImageDesc();
			// if local colortable set firstFrame = false
			// if (!firstFrame) {writePalette(); }
			// pixels need to be indices
