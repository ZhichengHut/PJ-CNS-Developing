...
public class GifDecoder {
	...
	/**
	 * Returns the GlobalColorTable as an int[] with Color bytes put into int
	 * (Int in bytes) Int = 00 RED GREEN BLUE
	 * 
	 * @return gct GlobalColorTable
	 */
	public int[] getGct() {
		return gct;
	}
	...
	/**
	 * Returns the LocalColorTable as an int[] with Color bytes put into int
	 * (Int in bytes) Int = 00 RED GREEN BLUE
	 * 
	 * @return lct LocalColorTable
	 */
	public int[] getLct() {
		return lct;
	}
	...
	/**
	 * Returns Pixel pointers(indices) as byte[]
	 * 
	 * @return pixels
	 */
